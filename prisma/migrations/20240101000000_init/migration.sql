-- Lihtea CRM — Migration initiale générée depuis schema.prisma
...
CREATE TYPE "ActivityType" AS ENUM ('EMAIL_IN', 'EMAIL_OUT', 'CALL', 'MEETING', 'NOTE', 'TASK_DONE', 'DEAL_MOVED', 'SEQUENCE_SENT', 'SIGNAL', 'ENRICHMENT');
...
CREATE TYPE "EnrollmentStatus" AS ENUM ('ACTIVE', 'PAUSED', 'COMPLETED', 'REPLIED', 'BOUNCED', 'UNSUBSCRIBED', 'REMOVED');
...
ALTER TABLE "lists" ADD CONSTRAINT "lists_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "list_members" ADD CONSTRAINT "list_members_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "sequences" ADD CONSTRAINT "sequences_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
CREATE INDEX "sequence_enrollments_nextSendAt_status_idx" ON "sequence_enrollments"("nextSendAt", "status");
...
ALTER TABLE "sequence_sends" ADD CONSTRAINT "sequence_sends_enrollmentId_fkey" FOREIGN KEY ("enrollmentId") REFERENCES "sequence_enrollments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "sequence_sends" ADD CONSTRAINT "sequence_sends_stepId_fkey" FOREIGN KEY ("stepId") REFERENCES "sequence_steps"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ─── PRISMA MIGRATIONS TABLE (pour que Prisma sache que la migration est faite) ──
